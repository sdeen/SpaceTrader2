 ...
 * @author gilugeorge
 */
public class SolarSystem3Controller extends SSController {

    @FXML
    private Shape amaterasuPlanet;
    @FXML
    private Shape tsukuyomiPlanet;
    @FXML
    private Shape susanooPlanet;
    @FXML
    private Shape izanamiPlanet;
    @FXML
     ...
     */
    @FXML
    private void amaterasuButton(ActionEvent event) throws IOException {
        if (Player.curPlanet.getPoint().distance(
                Universe.getSolarSystem(2).getPlanet(0).getPoint()) > Player.curShip
                .getRemainingFuel()) {
...
//                    + Player.curShip.getRemainingFuel());
     ...
     */
    @FXML
    private void tsukuyomiButton(ActionEvent event) throws IOException {
        if (Player.curPlanet.getPoint().distance(
                Universe.getSolarSystem(2).getPlanet(1).getPoint()) > Player.curShip
                .getRemainingFuel()) {
            JOptionPane.showMessageDialog(null, "Not enough fuel :(");
        } else {
            ...
            Planet.setEvent();
            Player.curShip.useFuel(Player.curPlanet.getPoint(), Universe
                    .getSolarSystem(2).getPlanet(1).getPoint());
            int result = JOptionPane.showConfirmDialog(null, " Radical Event: "
                    + Planet.getRadicalEvent() + "\nYou will have "
                    + Player.curShip.getRemainingFuel() + " fuel rmaining."
                    + "\nWould you like to proceed?", null,
            ...
            Player.curPlanet = Universe.getSolarSystem(2).getPlanet(1);
            Player.curShip.useFuel(Player.getLocation(),
                    Player.curPlanet.getPoint());
//            System.out.println("Current Fuel: "
//                    + Player.curShip.getRemainingFuel());
     ...
     */
    @FXML
    private void susanooButton(ActionEvent event) throws IOException {
        if (Player.curPlanet.getPoint().distance(
                Universe.getSolarSystem(2).getPlanet(2).getPoint()) > Player.curShip
                .getRemainingFuel()) {
            JOptionPane.showMessageDialog(null, "Not enough fuel :(");
        } else {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
            ...
            if (result == JOptionPane.YES_OPTION) {
                Player.curShip.useFuel(Player.curPlanet.getPoint(), Universe
                        .getSolarSystem(2).getPlanet(2).getPoint());
            }
            if (result == JOptionPane.NO_OPTION) {
                FXMLLoader loader1 = new FXMLLoader(getClass().getResource(
                        "SolarSystem3.fxml"));
            ...
            Player.curPlanet = Universe.getSolarSystem(2).getPlanet(2);
            Player.curShip.useFuel(Player.getLocation(),
                    Player.curPlanet.getPoint());
//            System.out.println("Current Fuel: "
//                    + Player.curShip.getRemainingFuel());
     ...
     */
    @FXML
    private void izanamiButton(ActionEvent event) throws IOException {
        if (Player.curPlanet.getPoint().distance(
                Universe.getSolarSystem(2).getPlanet(3).getPoint()) > Player.curShip
                .getRemainingFuel()) {
            JOptionPane.showMessageDialog(null, "Not enough fuel :(");
        } else {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
            ...
            if (result == JOptionPane.YES_OPTION) {
                Player.curShip.useFuel(Player.curPlanet.getPoint(), Universe
                        .getSolarSystem(2).getPlanet(3).getPoint());
            }
            if (result == JOptionPane.NO_OPTION) {
                FXMLLoader loader1 = new FXMLLoader(getClass().getResource(
                        "SolarSystem3.fxml"));
            ...
            Player.curPlanet = Universe.getSolarSystem(2).getPlanet(3);
            Player.curShip.useFuel(Player.getLocation(),
                    Player.curPlanet.getPoint());
//            System.out.println("Current Fuel: "
//                    + Player.curShip.getRemainingFuel());
     ...
     */
    @FXML
    private void izanagiButton(ActionEvent event) throws IOException {
        if (Player.curPlanet.getPoint().distance(
                Universe.getSolarSystem(2).getPlanet(4).getPoint()) > Player.curShip
                .getRemainingFuel()) {
            JOptionPane.showMessageDialog(null, "Not enough fuel :(");
        } else {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
            ...
            if (result == JOptionPane.YES_OPTION) {
                Player.curShip.useFuel(Player.curPlanet.getPoint(), Universe
                        .getSolarSystem(2).getPlanet(4).getPoint());
            }
            if (result == JOptionPane.NO_OPTION) {
                FXMLLoader loader1 = new FXMLLoader(getClass().getResource(
                        "SolarSystem3.fxml"));
            ...
            Player.curPlanet = Universe.getSolarSystem(2).getPlanet(4);
            Player.curShip.useFuel(Player.getLocation(),
                    Player.curPlanet.getPoint());
//            System.out.println("Current Fuel: "
//                    + Player.curShip.getRemainingFuel());
    ...
    /*
     * When the player hover over each planet in Solar System 3, the current
    ...
    private void showInfo(MouseEvent event) {
        planetOne = Universe.getSolarSystem(2).getPlanet(0);
        planetTwo = Universe.getSolarSystem(2).getPlanet(1);
        planetThree = Universe.getSolarSystem(2).getPlanet(2);
        planetFour = Universe.getSolarSystem(2).getPlanet(3);
        planetFive = Universe.getSolarSystem(2).getPlanet(4);
        if (amaterasuPlanet.isHover()) {
            infoLabel.setText("Planet Information: \n" + planetOne.toString());
        } else if (tsukuyomiPlanet.isHover()) {
            infoLabel.setText("Planet Information: \n" + planetTwo.toString());
        } else if (susanooPlanet.isHover()) {
            infoLabel
                    .setText("Planet Information: \n" + planetThree.toString());
        } else if (izanamiPlanet.isHover()) {
            infoLabel.setText("Planet Information: \n" + planetFour.toString());
        } else {
            infoLabel.setText("Planet Information: \n" + planetFive.toString());
        }
